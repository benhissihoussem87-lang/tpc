<?php
   $brd=new Borderos();
	...
	$QtesFactures=$Autresfacture->getQtesFacturesPonctuel($_GET['numFacture'],$_GET['anneeFacture']); 
	...
	<td ><textarea style="width:220px; height:100px" name="article1" placeholder="Nom" class="form-control" ><?php echo $res['article1']?></textarea></td>
			<td ><input  type="number" name="qte1"  value="<?php if($cle['qte1']!=0){ echo $cle['qte1'];} else {echo 0;}?>" class="form-control"  ></td>
