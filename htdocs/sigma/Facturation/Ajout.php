...
if(isset($_POST['ok']))
{
 if($projet->AjoutSousProjet($_POST['code_P'],$_POST['code_sp'],$_POST['mdo'],str_replace("'","\'",$_POST['titre']),$_POST['etat'],$_POST['titre_s'],$_POST['d_rp'],$_POST['d_rd'],$_POST['ddsp'],str_replace("'","\'",$_POST['observation'])))
...
<label for="codep">Code Projet</label>
					...
					<datalist id="codeps">
					 <?php foreach($projets as $detprojet)
					 {
					 ?>
		...
		<td style="padding-left:45px">
					...
					<input style="padding:6px 0 6px 4px;width:100px"  id="code_sp" class="form-control" type="text" name="code_sp">
					</div></td>
					<td ><p id="res_SP" style="color:red; position:relative; top:20px;"></p></td>
					</tr></table>
					</td>
					
					<td><div id="res_sousProjet"></div></td>
