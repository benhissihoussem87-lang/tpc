...
/*****/
		 ...
		 /**********/	
 if($projet->ModifierProjet($_GET['P_modifier'],str_replace("'","\'",$_POST['titre']),str_replace("'","\'",$_POST['intitule']),$lien))
 {
...
<table width=40%  style="position:relative;top:15px" >
<tr>
      <td width=50%> <label for="codeprojet">Code Projet</label></td>
	   
	   <td width=10% ><b style="font-size:25px">C</b></td>
       <td width=40%>
	   <input type="text" name="code_projet"  readonly  value="<?php echo $det['code_projet'] ?>" id="codeprojet" style="padding:6px 0 6px 4px;" name="code_AO" class="form-control"></td>
					</tr>
					</table>
...
<textarea readonly  id="titre" style="padding:4px 0 4px 4px" name="titre" class="form-control"><?php echo $det['titre'] ?></textarea>
			...
			<td>3</td>
			  ...
			  <td width=10%><label for="designer">Date Reception BC</label>
						...
						<input type="date" value="<?php echo $det['date_receptionBC']?>" id="designer" style="padding:6px 0 6px 4px" name="date_receptionBC" class="form-control"  >
						</td>
			  <td width=10%><label for="designer">Date BC</label>
					 
						<input type="date" value="<?php echo $det['date_B_C']?>" id="designer" style="padding:6px 0 6px 4px" name="date_BC" class="form-control"  >
						</td>
