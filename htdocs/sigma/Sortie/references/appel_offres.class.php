...
public function __construct()
	...
	public function ModifierAO($id,$titre,$intitule,$vis_a_vis)
	{
	...
	if($_SESSION['user']=='utilisateur')
	 {
		...
		@  $sql="update offres set code='".$_POST['code']."',type='".$_POST['type']."',mdo='".$_POST['mdo']."',titre='$titre',date_limite='".$_POST['date_limite']."',date_decharge='".$_POST['date_decharge']."',cout='".$_POST['cout']."',bordero='".$_FILES['bordero']['name']."',
	  ...
	  @ $sql="update offres set code='".$_POST['code']."',type='".$_POST['type']."',etat='".$_POST['etat']."',mdo='".$_POST['mdo']."',titre='$titre',date_limite='".$_POST['date_limite']."',date_decharge='".$_POST['date_decharge']."',cout='".$_POST['cout']."',bordero='".$_FILES['bordero']['name']."',
		 hono='".$_POST['hono']."',intitule='$intitule',pourcentage='".$_POST['pourcentage']."',nb_vis='".$_POST['nb_vis']."',rp_rd='".$_POST['rp_rd']."',`Typeuser`='".$_SESSION['user']."',`vis_a_vis`='$vis_a_vis' where id='$id'";
