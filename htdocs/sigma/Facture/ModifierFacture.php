...
{
$infosFacture=$facture->getInfosFacture($_GET['id']);	
}
else if(isset($_GET['FactureNews']))
...
if(isset($_POST['ok']))
 ...
 /*****/
	...
	if($_POST['ok']=='Modifier')
	 {
		 // Modifier RecP de Facture
//$facture->ModifierRecPFacture($_POST['numfacture'],$detailFact['mantant'],$_POST['dateRecouvrement']);
// Pour modifier RecP
//$facture->ModifierRecPFacture($_POST['numfacture'],$_POST['mantant'],$_POST['dateRecouvrement']);
//Fin RecP	
		 $lien=null;
    ...
    @$verifFacture=count($facture->VerifFacturesExistes($factures[0],$factures[1]));
...
if($verifFacture==0)
{
	...
	echo '<h1>Vérifier N° Facture</h1>';	
	 ...
	 {
		 $numFacture=$_GET['numFacture'].'/'.$_GET['anneeFacture'];
		if($facture->deletefactures($_GET['id'],$numFacture) )
		{
			$borderos->deleteBorderoFacture($numFacture,null);
		//echo '<h1>Facture Ajouté avec Succée</h1>';
		echo "<script>document.location.href='sigma.php?AfficherFacture&factures'</script>";
		}
		else 
		echo '<h1>Erreur</h1>'; 
	 }
...
<div class="container" style="position:relative; top:-60px"  >
      <div class="card card-register mx-auto mt-5" >
        <div class="card-header">Modifier <?php if(!isset($_GET['P'])){?> Facture<?php } else { ?> Projet<?php } ?>
		<a href="Facture/detailFacture.php?id=<?php echo $_GET['id']?>&AO=<?php echo $_GET['codeAO']?>&Facture=<?php echo $_GET['numFacture']?>&Annee=<?php echo $_GET['anneeFacture']?>&montant=<?php echo $detailFact['mantant']?>&Pourcentage=<?php echo $detailFact['pourcentage']?>&designation=<?php echo $detailFact['designation']?>" class="btn btn-primary btn-block" style="width:200px;position:relative; top:10px;">IMPRIMER</a>
		  <input type="submit" style="width:200px; margin:auto;position:relative; top:-30px;margin-bottom:-30px;left:-100px" id="ok" value="Modifier" name="ok" class="btn btn-primary btn-block"/>
			...
			<?php if($_GET['codeAO']!='Ponct'){?>
			 <input type="submit" style="width:200px; margin:auto;position:relative; top:-50px;margin-bottom:-30px;float:right" id="ok" value="New Facture" name="newFacture" class="btn btn-danger"/>
			<?php } ?>
		  </div>
...
$Facts=$borderos->getFactureAO($_GET['id'],$_GET['codeAO']);
...
<td valign=top width=50%  >
	...
	<table border=1   class="table table-bordered" id="factureCreation"  cellspacing="0">
			...
			if($_GET['codeAO']!='Ponct')
			{
				...
				<th width=5%><span style="font-size:12px">Qte<br> Brd</span></th>
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte1']?>"></td>
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte2']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte3']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
			...
			<td style="margin:0;padding:0;font-size:12px;height:50px" valign=top>
			<textarea type="text" name="article4" style="border:none;float:left;height:100px;width:100%;top:-10px;padding-top:10px;" readonly><?php echo $cle['article4']?>
			</textarea>
			</td>
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte4']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
			...
			<td style="margin:0;padding:0;font-size:12px;height:50px" valign=top>
			<textarea type="text" name="article5" style="border:none;float:left;height:100px;width:100%;top:-10px;padding-top:10px;" readonly><?php echo $cle['article5']?>
			</textarea>
			</td>
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte5']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="margin:0;padding:0;font-size:12px;height:50px" valign=top>
			<textarea type="text" name="article6" style="border:none;float:left;height:100px;width:100%;top:-10px;padding-top:10px;" readonly><?php echo $cle['article6']?>
			</textarea>
			</td>
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte6']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="margin:0;padding:0;font-size:12px;height:50px" valign=top>
			<textarea type="text" name="article7" style="border:none;float:left;height:100px;width:100%;top:-10px;padding-top:10px;" readonly><?php echo $cle['article7']?>
			</textarea>
			</td>
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte7']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte8']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte9']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte10']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<tr>
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte11']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte12']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<tr>
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte13']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte14']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte15']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte16']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte17']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte18']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="margin:0;padding:0;font-size:12px;height:50px" valign=top>
			<textarea type="text" name="article19" style="border:none;float:left;height:50px;width:100%;top:-10px;padding-top:10px;" readonly>
			<?php echo $cle['article19']?>
			</textarea>
			</td>
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte19']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
		...
		<?php
			...
			<td style="font-size:12px;padding:5px 0 0 0;" align=center>
			<input style="border:none;width:25px;" readonly type="text" value="<?php echo $cle['qte20']?>"></td>
			<td style="margin:0;padding:10px 0 0 0;height:50px;">
	...
	<table style="width:400px;float:right;position:relative;top:-50px" >
