    ...
    if ($num === '') {
        ...
        foreach ($lines as $line) {
            $normalized[] = [
                ...
                'adresseClient'  => $line['adresseClient'],
            ];
        }
                  ...
                  <td>
                    <select class="form-control" name="line_projet[]">
                      ...
                      <?php foreach ($projetsList as $p) { ?>
                        <option value="<?= (int)$p['id'] ?>" <?= ($line['projet'] ?? null) == $p['id'] ? 'selected' : '' ?>>
                          <?= htmlspecialchars($p['classement'] ?? $p['designation'] ?? ('Projet '.$p['id'])) ?>
                        </option>
                      <?php } ?>
                    </select>
                  </td>
          ...
          <tr>
            <td>
              <select class="form-control" name="line_projet[]">
                <option value="">--</option>
                <?php foreach ($projetsList as $p) { ?>
                  <option value="<?= (int)$p['id'] ?>"><?= htmlspecialchars($p['classement'] ?? $p['designation'] ?? ('Projet '.$p['id'])) ?></option>
                <?php } ?>
              </select>
            </td>
        ...
        <div class="table-responsive">
          <table class="table table-sm table-bordered">
            ...
            <tbody>
              <?php foreach ($selectedLines as $line) { ?>
                <tr>
                  <td><?= htmlspecialchars($projetsMap[$line['projet']] ?? ($line['projet'] ?? '-')) ?></td>
                  ...
                  <td><?= htmlspecialchars($line['adresseClient']) ?></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
