...
class GRHS{
	...
	public function Ajout($nomPersonnel,$ADRESS,$LibelleAdresse,$TitreDiplome,$DIPLOME,$TitreFormation,$FORMATION,$fiche_paie,$typeContrat,$CONTRAT,$post,$cin){
	  ...
	  echo	$sql="insert into grh values('','$nomPersonnel','$ADRESS','$LibelleAdresse','$TitreDiplome','$DIPLOME','$TitreFormation','$FORMATION','$fiche_paie','$typeContrat','$CONTRAT','$post','$cin')";
