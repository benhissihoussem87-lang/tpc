...
// Ajout GRH
 if(isset($_REQUEST['btnSubmitAjout'])){
 	if($grh->Ajout(@$_POST['nomPersonnel'],@$_FILES['ADRESS']['name'],str_replace("'","\'",@$_POST['LibelleAdresse']),str_replace("'","\'",@$_POST['TitreDiplome']),@$_FILES['DIPLOME']['name'],str_replace("'","\'",@$_POST['TitreFormation']),@$_FILES['FORMATION']['name'],@$_FILES['fiche_paie']['name'],str_replace("'","\'",@$_POST['typeContrat']),@$_FILES['CONTRAT']['name'],str_replace("'","\'",@$_POST['post'])))
	{
...
<!-- Form Ajout Dossier -->
    <div class="card shadow mb-4">
	 ...
	 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	  <thead>
             <tr>
				<th >Personnel</th><th>Libelle Adresse</th><th >Adresse</th>
