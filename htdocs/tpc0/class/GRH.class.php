...
class GRHS{
	...
	// Ajout GRH
	public function Ajout($nomPersonnel,$ADRESS,$LibelleAdresse,$TitreDiplome,$DIPLOME,$TitreFormation,$FORMATION,$fiche_paie,$typeContrat,$CONTRAT,$post){
		
	  echo	$sql="insert into grh values('','$nomPersonnel','$ADRESS','$LibelleAdresse','$TitreDiplome','$DIPLOME','$TitreFormation','$FORMATION','$fiche_paie','$typeContrat','$CONTRAT','$post')";
	...
	// Modifier GRH
	public function Modifier($nomPersonnel,$ADRESS,$LibelleAdresse,$TitreDiplome,$DIPLOME,$TitreFormation,$FORMATION,$fiche_paie,$typeContrat,$CONTRAT,$post,$id){
		
	  echo	$sql="update grh set nomPersonnel='$nomPersonnel',ADRESS='$ADRESS',LibelleAdresse='$LibelleAdresse',TitreDiplome='$TitreDiplome',DIPLOME='$DIPLOME',TitreFormation='$TitreFormation',FORMATION='$FORMATION',fiche_paie='$fiche_paie',typeContrat='$typeContrat',CONTRAT='$CONTRAT',POSTE='$post' where id_grh='$id'";
...
if($libelle=='fiche_paie' or $libelle=='POSTE')
